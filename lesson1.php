...
//alert(key);
	...
	$(document).ready(function(){
		var result="";
		function next(){
				window.location.href="lesson1.php?next="+result;
				<?php
				if(isset($_GET['next'])){
					...
					if($conn->connect_error){
						...
						$temp2=$temp2.",".$temp3;
						$val=mysqli_query($conn,"UPDATE lesson_data SET lesson1='$temp2' WHERE username='$temp1'");
...
<body align="center">
	...
	<center>
	<p id="one" style="font-size:40px">jjj kkk jkj jkj
kjk jjj kkk jk kj
jj kk jk kj jk jj
jk kk kj j k j jkj
jjk kjj kkj jkk kkk
