...
//alert(key);
	...
	$(document).ready(function(){
		var result="";
		function next(){
				window.location.href="lesson11.php?next="+result;
				<?php
				if(isset($_GET['next'])){
					...
					if($conn->connect_error){
						...
						$temp2=$temp2.",".$temp3;
						$val=mysqli_query($conn,"UPDATE lesson_data SET lesson11='$temp2' WHERE username='$temp1'");
...
<body align="center">
	...
	<center>
	<p id="one" style="font-size:40px">1234567890
112 234 543 678 966
474 868 979 889
21456 3489 7326 
1769 6529</p>
