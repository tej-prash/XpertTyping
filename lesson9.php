...
//alert(key);
	...
	$(document).ready(function(){
		var result="";
		function next(){
				window.location.href="lesson9.php?next="+result;
				<?php
				if(isset($_GET['next'])){
					...
					if($conn->connect_error){
						...
						$temp2=$temp2.",".$temp3;
						$val=mysqli_query($conn,"UPDATE lesson_data SET lesson9='$temp2' WHERE username='$temp1'");
...
<body align="center">
	...
	<center>
	<p id="one" style="font-size:40px">777 88 878 787
78 88 778 887
99 00 909 009
9 9 900 99 090
444 333 343 443
