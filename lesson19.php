...
//alert(key);
	...
	$(document).ready(function(){
		var result="";
		function next(){
				window.location.href="lesson19.php?next="+result;
				<?php
				if(isset($_GET['next'])){
					...
					if($conn->connect_error){
						...
						$temp2=$temp2.",".$temp3;
						$val=mysqli_query($conn,"UPDATE lesson_data SET lesson19='$temp2' WHERE username='$temp1'");
...
<body align="center">
	...
	<center>
	<p id="one" style="font-size:40px">zebras are not exactly 
known for being quiet animals.
he/she would very likely just play 
along for a while.you can make quite 
a lot of lemon zest with even larger
sized lemons; please cover each plate.</p>
<div>
<script>
