...
//alert(key);
	...
	$(document).ready(function(){
		var result="";
		function next(){
				window.location.href="lesson21.php?next="+result;
				<?php
				if(isset($_GET['next'])){
					...
					if($conn->connect_error){
						...
						$temp2=$temp2.",".$temp3;
						$val=mysqli_query($conn,"UPDATE lesson_data SET lesson21='$temp2' WHERE username='$temp1'");
...
<body align="center">
	...
	<center>
	<p id="one" style="font-size:40px">New keys : ':','?',':'?',
' ','!',"!" ','.
That's awesome! Congrats -- 
did you think it'd be so easy ? 
Yes? No? Maybe? I'll bet it was "a 
walk in the park."</p>
<div>
<script>
