...
//alert(key);
	...
	$(document).ready(function(){
		var result="";
		function next(){
				window.location.href="lesson12.php?next="+result;
				<?php
				if(isset($_GET['next'])){
					...
					if($conn->connect_error){
						...
						$temp2=$temp2.",".$temp3;
						$val=mysqli_query($conn,"UPDATE lesson_data SET lesson12='$temp2' WHERE username='$temp1'");
