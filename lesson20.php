...
//alert(key);
	...
	$(document).ready(function(){
		var result="";
		function next(){
				window.location.href="lesson20.php?next="+result;
				<?php
				if(isset($_GET['next'])){
					...
					if($conn->connect_error){
						...
						$temp2=$temp2.",".$temp3;
						$val=mysqli_query($conn,"UPDATE lesson_data SET lesson20='$temp2' WHERE username='$temp1'");
...
<body align="center">
	...
	<center>
	<p id="one" style="font-size:40px">WOW. Four Jacks And One Queen,
I Win.Please Do Not Go Up There Now.
Zack needs MORE caramel Kettle Corn 
ASAP.Bobody Even HAS Any Purple
Vests.Xavier Let Seventl Yellow 
BEES Into Our Cabin.YIKES.</p>
<div>
<script>
